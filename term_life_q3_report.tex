...
For transparency, the empirical materials are intended to be stored together in the GitHub repository
\begin{center}
\href{\githubrepo}{\texttt{Looloo-dot/term-life-insurance}}.
\end{center}
The key files are linked below:
\begin{itemize}
\item Dataset: \href{\githubrepo/blob/main/Term\%20Life\%20Insurance.csv}{\texttt{Term Life Insurance.csv}}
\item Jupyter notebook: \href{\githubrepo/blob/main/Q3\%20notebook.ipynb}{\texttt{Q3 notebook.ipynb}}
\item Figure: \href{\githubrepo/blob/main/figures/figure1\_distribution\_model\_comparison.png}{\texttt{figure1\_\allowbreak distribution\_\allowbreak model\_\allowbreak comparison.png}}
\item LaTeX report source: \href{\githubrepo/blob/main/term\_life\_q3\_report.tex}{\texttt{term\_life\_q3\_report.tex}}
\end{itemize}
